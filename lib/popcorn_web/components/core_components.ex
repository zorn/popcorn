defmodule PopcornWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PopcornWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PopcornWeb.Gettext, "errors", msg, opts)
    end
  end
